...
var h = 700;
var terrain;
var slider; //var offIncr; //Intensity
...
function setup() {
  ...
  cnv.style('border-radius', '25px'); // Slider
...
function windowResized() {
  this._renderer.position(50 >> 1, this.height >> 1);

  var sliderX = (this.width - slider.width >> 1) + this._renderer.x,
